			...
			<div class="col-md-4">
				<div class="card">
					<div class="card-body px-3">
						...
						<!--admin-form-->
						<form action="${pageContext.request.contextPath}/admin/manage?operation=save" method="post">
							<div class="mb-3">
					...
					<div class="card-body px-3">
						<table class="table table-hover">
							...
							<tr class="text-center">
								...
								<td><%=a.getEmail() %></td>
								<td><%=a.getPhone() %></td>
								<td><a href="${pageContext.request.contextPath}/admin/manage?operation=delete&id=<%=a.getId()%>" role="button" class="btn btn-danger">Remove</a></td>
							</tr>
							<%
							}
							%>
