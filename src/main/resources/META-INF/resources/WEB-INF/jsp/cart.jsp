...
<body>
	...
	<div class="container text-center py-5 px-5">
		<img src="../../../../../java/com/ecommerce/webapp/Images/empty-cart.png" style="max-width: 250px;"
			 class="img-fluid">
			...
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr class="text-center">
						...
						<td><a
							href="${pageContext.request.contextPath}/cart/operation?cid=<%=c.getCartId()%>&opt=1"
						...
						<div class="qty"><%=c.getQuantity()%></div>
							<%if(c.getQuantity() > 1){ %>
							<a href="${pageContext.request.contextPath}/cart/operation?cid=<%=c.getCartId()%>&opt=2"
						...
						<td><a
							href="${pageContext.request.contextPath}/cart/operation?cid=<%=c.getCartId()%>&opt=3"
