	...
	<div class="container-fluid py-4 px-3">
		...
		<div class="row">
			<div class="container text-center" id="details">
				<img src="../../../../../java/com/ecommerce/webapp/Images/admin.png" style="max-width: 180px;"
                     class="img-fluid">
				<h3>
			...
			<div class="row px-3 py-3">
				<div class="col-md-4">
					<a href="display_category.jsp">
						<div class="card text-bg-light mb-3 text-center">
							<div class="card-body">
								<img src="../../../../../java/com/ecommerce/webapp/Images/categories.png" style="max-width: 80px;"
                                     class="img-fluid">
				...
				<div class="col-md-4">
					<a href="display_products.jsp">
						<div class="card text-bg-light mb-3 text-center">
							<div class="card-body">
								<img src="../../../../../java/com/ecommerce/webapp/Images/products.png" style="max-width: 80px;"
                                     class="img-fluid">
				...
				<div class="col-md-4">
					<a href="display_orders.jsp">
						<div class="card text-bg-light mb-3 text-center">
							<div class="card-body">
								<img src="../../../../../java/com/ecommerce/webapp/Images/order.png" style="max-width: 80px;"
                                     class="img-fluid">
			...
			<div class="row px-3">
				<div class="col-md-4 offset-md-2">
					<a href="display_users.jsp">
						<div class="card text-bg-light mb-3 text-center">
							<div class="card-body">
								<img src="../../../../../java/com/ecommerce/webapp/Images/users.png" style="max-width: 80px;"
                                     class="img-fluid">
				...
				<div class="col-md-4">
					<a href="display_admin.jsp">
						<div class="card text-bg-light mb-3 text-center">
							<div class="card-body">
								<img src="../../../../../java/com/ecommerce/webapp/Images/add-admin.png" style="max-width: 80px;"
                                     class="img-fluid">
	...
	<div class="modal fade" id="add-category" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form action="${pageContext.request.contextPath}/admin/operation" method="post"
